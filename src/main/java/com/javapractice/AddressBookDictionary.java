				...
				case '4':
					...
					while(flag1==0)
					{
						...
						if(searchparameter=='1')
						{
							...
							DictionaryOperations.diplayCriteriaDetails(DictionaryOperations.searchByCriteria('1',searchCity));
						}
						else if(searchparameter=='2')
						{
							...
							DictionaryOperations.diplayCriteriaDetails(DictionaryOperations.searchByCriteria('2',searchState));
						}
						else if(searchparameter=='3')
						{
							...
							DictionaryOperations.diplayCriteriaDetails(DictionaryOperations.searchByCriteria('3',searchZip));
						}
						else
						{	
				...
				case '5':
					...
					while(flag2==0)
					{
						...
						if(countparameter=='1')
						{
							...
							System.out.println("Enter city name: ");
							String searchCity= sc.nextLine();
							System.out.println(DictionaryOperations.searchByCriteria('1',searchCity).size() + " people living in "+ searchCity);
						}
						else if(countparameter=='2')
						{
							...
							System.out.println("Enter state name: ");
							String searchState= sc.nextLine();
							System.out.println(DictionaryOperations.searchByCriteria('2',searchState).size() + " people living in "+ searchState);
						}
						...
						{		
							...
							String searchZip= sc.nextLine();
							System.out.println(DictionaryOperations.searchByCriteria('3',searchZip).size() + " people living in "+ searchZip);
						}
						else	
						{	
							System.out.println("Wrong Choice!");
